  ...
  return (
    <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg mb-6 border border-slate-200 dark:border-slate-700">
      ...
      <div className="flex justify-between items-center">
        ...
        {/* Post Button */}
        <button className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-6 py-2 rounded-xl font-medium transition-all transform hover:scale-105">
          Post
        </button>
      </div>
    </div>
